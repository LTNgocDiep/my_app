...
def add_qa_status_to_task():
    ...
    try:
        ...
        if "QA Pending" not in current_options:
            ...
            print("--- THÀNH CÔNG: Đã thêm QA Pending vào Status của Task ---")
        else:
            print("--- THÔNG BÁO: QA Pending đã tồn tại rồi ---")
            
    except Exception as e:
        frappe.log_error(frappe.get_traceback(), "Lỗi khi chạy add_qa_status_to_task")
